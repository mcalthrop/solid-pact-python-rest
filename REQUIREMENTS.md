...
- have a front end built using SolidJS
- have a back end REST API built using Python
...
- built using SolidJS with TypeScript
- uses accepted best practices for SolidJS and TypeScript
...
- written in Python
- exposes a REST API
- uses accepted best practices for Python
